note
	description: "Command to display the relations of a feature."
...
feature{NONE} -- Implementation
	...
	result_data: QL_FEATURE_DOMAIN
		...
		local
			l_worker: E_SHOW_NOTE_RELATIONS
		do
			...
			print(Result)
			--Result.extend (create {QL_REAL_FEATURE}.make_with_parent (associated_feature))
			--print(Result.last)
		end
